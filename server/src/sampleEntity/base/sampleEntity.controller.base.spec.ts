...
describe("SampleEntity", () => {
  ...
  test("POST /sampleEntities", async () => {
  ...
  test("GET /sampleEntities/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/sampleEntities"}/${nonExistingId}`)
  ...
  test("GET /sampleEntities/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/sampleEntities"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
